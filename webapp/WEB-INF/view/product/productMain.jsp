			...
			<div class="product-list">
				...
				<ul class="product clearfix">
					...
					<c:forEach items="${productList.data}" var="product">
						...
						<!-- 隐藏域封装大类的ID -->
						<input type="hidden" id="bigTypeId" value="${product.bigType.ID }" />
	...
	<script>
          ...
          var pagination = new Pagination({
          	  ...
          	  callback: function(pageNum) { // 每一个页数按钮的回调事件
           		...
           		//得到隐藏域中大类的ID 
           		var id = $("#bigTypeId").val();
           		
           		//使用js来发送请求，请求Action，要把页码传给Action
           		window.location.href="searchProduct.action?product.bigType.ID="+id+"&currentPage="+pageNum;
          	  }
          	});
       </script>
