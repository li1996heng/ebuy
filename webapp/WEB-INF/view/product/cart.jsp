			...
			<div class="M_cart">
				...
				<table>
						<tr class="cartinfo_sgoods">
							<td class="cartinfo_pic first"><img src="${cart.product.proPic }" /></td>
							...
							<td class="txt"><span><a href="#">收藏</a><br />
								<a href="#">换一件</a></span></td>
						</tr>
				...
				<div class="all_value">
					<div class="all_valuebox">
						<span>总计</span><span>${cart.price }<em>.00</em><em>¥</em></span>
					</div>
				</div>
				<ol class="ftxt">
					<li><span>寄送至：</span><span>${cart.user.address }</span></li>
					<li><span>收货人：</span><span>${cart.user.name }</span></li>

				</ol>

				<div class="pay">
					<a href="createOrder.action?cart.id=${cart.id }">结算</a>
				</div>
